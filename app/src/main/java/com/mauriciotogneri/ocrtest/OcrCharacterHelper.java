...
public class OcrCharacterHelper
{
    ...
    public static String getDefaultBlacklist(String languageCode)
    {
        ...
        else if (languageCode.equals("aze"))
        {
            return "";
        } // Azeri
        else if (languageCode.equals("eus"))
        {
            return "";
        } // Basque
        ...
        else if (languageCode.equals("ben"))
        {
            return "";
        } // Bengali
        ...
        else if (languageCode.equals("glg"))
        {
            return "";
        } // Galician
        ...
        else if (languageCode.equals("kan"))
        {
            return "";
        } // Kannada
        ...
        else if (languageCode.equals("msa"))
        {
            return "";
        } // Malay
        else if (languageCode.equals("mal"))
        {
            return "";
        } // Malayalam
        else if (languageCode.equals("mlt"))
        {
            return "";
        } // Maltese
        ...
        else if (languageCode.equals("swa"))
        {
            return "";
        } // Swahili
        ...
        else if (languageCode.equals("tam"))
        {
            return "";
        } // Tamil
        else if (languageCode.equals("tel"))
        {
            return "";
        } // Telugu
    ...
    public static String getBlacklist(SharedPreferences prefs, String languageCode)
    {
        if (languageCode.equals("afr"))
        {
            return prefs.getString(KEY_CHARACTER_BLACKLIST_AFRIKAANS, getDefaultBlacklist(languageCode));
        }
        else if (languageCode.equals("sqi"))
        {
            return prefs.getString(KEY_CHARACTER_BLACKLIST_ALBANIAN, getDefaultBlacklist(languageCode));
        }
        else if (languageCode.equals("ara"))
        {
        ...
        {
            return prefs.getString(KEY_CHARACTER_BLACKLIST_AZERI, getDefaultBlacklist(languageCode));
        }
        else if (languageCode.equals("eus"))
        {
            return prefs.getString(KEY_CHARACTER_BLACKLIST_BASQUE, getDefaultBlacklist(languageCode));
        }
        else if (languageCode.equals("bel"))
        {
            return prefs.getString(KEY_CHARACTER_BLACKLIST_BELARUSIAN, getDefaultBlacklist(languageCode));
        }
        else if (languageCode.equals("ben"))
        {
            return prefs.getString(KEY_CHARACTER_BLACKLIST_BENGALI, getDefaultBlacklist(languageCode));
        }
        else if (languageCode.equals("bul"))
        {
        ...
        {
            return prefs.getString(KEY_CHARACTER_BLACKLIST_CROATIAN, getDefaultBlacklist(languageCode));
        }
        else if (languageCode.equals("ces"))
        {
        ...
        {
            return prefs.getString(KEY_CHARACTER_BLACKLIST_ESTONIAN, getDefaultBlacklist(languageCode));
        }
        else if (languageCode.equals("fin"))
        {
        ...
        {
            return prefs.getString(KEY_CHARACTER_BLACKLIST_GALICIAN, getDefaultBlacklist(languageCode));
        }
        else if (languageCode.equals("deu"))
        {
        ...
        {
            return prefs.getString(KEY_CHARACTER_BLACKLIST_ICELANDIC, getDefaultBlacklist(languageCode));
        }
        else if (languageCode.equals("ind"))
        {
        ...
        {
            return prefs.getString(KEY_CHARACTER_BLACKLIST_KANNADA, getDefaultBlacklist(languageCode));
        }
        else if (languageCode.equals("kor"))
        {
        ...
        {
            return prefs.getString(KEY_CHARACTER_BLACKLIST_MACEDONIAN, getDefaultBlacklist(languageCode));
        }
        else if (languageCode.equals("msa"))
        {
            return prefs.getString(KEY_CHARACTER_BLACKLIST_MALAY, getDefaultBlacklist(languageCode));
        }
        else if (languageCode.equals("mal"))
        {
            return prefs.getString(KEY_CHARACTER_BLACKLIST_MALAYALAM, getDefaultBlacklist(languageCode));
        }
        else if (languageCode.equals("mlt"))
        {
            return prefs.getString(KEY_CHARACTER_BLACKLIST_MALTESE, getDefaultBlacklist(languageCode));
        }
        else if (languageCode.equals("nor"))
        {
        ...
        {
            return prefs.getString(KEY_CHARACTER_BLACKLIST_SWAHILI, getDefaultBlacklist(languageCode));
        }
        else if (languageCode.equals("swe"))
        {
        ...
        {
            return prefs.getString(KEY_CHARACTER_BLACKLIST_TAMIL, getDefaultBlacklist(languageCode));
        }
        else if (languageCode.equals("tel"))
        {
            return prefs.getString(KEY_CHARACTER_BLACKLIST_TELUGU, getDefaultBlacklist(languageCode));
        }
        else if (languageCode.equals("tha"))
        {
    ...
    public static String getWhitelist(SharedPreferences prefs, String languageCode)
    {
        if (languageCode.equals("afr"))
        {
            return prefs.getString(KEY_CHARACTER_WHITELIST_AFRIKAANS, getDefaultWhitelist(languageCode));
        }
        else if (languageCode.equals("sqi"))
        {
            return prefs.getString(KEY_CHARACTER_WHITELIST_ALBANIAN, getDefaultWhitelist(languageCode));
        }
        else if (languageCode.equals("ara"))
        {
        ...
        {
            return prefs.getString(KEY_CHARACTER_WHITELIST_AZERI, getDefaultWhitelist(languageCode));
        }
        else if (languageCode.equals("eus"))
        {
            return prefs.getString(KEY_CHARACTER_WHITELIST_BASQUE, getDefaultWhitelist(languageCode));
        }
        else if (languageCode.equals("bel"))
        {
            return prefs.getString(KEY_CHARACTER_WHITELIST_BELARUSIAN, getDefaultWhitelist(languageCode));
        }
        else if (languageCode.equals("ben"))
        {
            return prefs.getString(KEY_CHARACTER_WHITELIST_BENGALI, getDefaultWhitelist(languageCode));
        }
        else if (languageCode.equals("bul"))
        {
        ...
        {
            return prefs.getString(KEY_CHARACTER_WHITELIST_CROATIAN, getDefaultWhitelist(languageCode));
        }
        else if (languageCode.equals("ces"))
        {
        ...
        {
            return prefs.getString(KEY_CHARACTER_WHITELIST_ESTONIAN, getDefaultWhitelist(languageCode));
        }
        else if (languageCode.equals("fin"))
        {
        ...
        {
            return prefs.getString(KEY_CHARACTER_WHITELIST_GALICIAN, getDefaultWhitelist(languageCode));
        }
        else if (languageCode.equals("deu"))
        {
        ...
        {
            return prefs.getString(KEY_CHARACTER_WHITELIST_ICELANDIC, getDefaultWhitelist(languageCode));
        }
        else if (languageCode.equals("ind"))
        {
        ...
        {
            return prefs.getString(KEY_CHARACTER_WHITELIST_KANNADA, getDefaultWhitelist(languageCode));
        }
        else if (languageCode.equals("kor"))
        {
        ...
        {
            return prefs.getString(KEY_CHARACTER_WHITELIST_MACEDONIAN, getDefaultWhitelist(languageCode));
        }
        else if (languageCode.equals("msa"))
        {
            return prefs.getString(KEY_CHARACTER_WHITELIST_MALAY, getDefaultWhitelist(languageCode));
        }
        else if (languageCode.equals("mal"))
        {
            return prefs.getString(KEY_CHARACTER_WHITELIST_MALAYALAM, getDefaultWhitelist(languageCode));
        }
        else if (languageCode.equals("mlt"))
        {
            return prefs.getString(KEY_CHARACTER_WHITELIST_MALTESE, getDefaultWhitelist(languageCode));
        }
        else if (languageCode.equals("nor"))
        {
        ...
        {
            return prefs.getString(KEY_CHARACTER_WHITELIST_SWAHILI, getDefaultWhitelist(languageCode));
        }
        else if (languageCode.equals("swe"))
        {
        ...
        {
            return prefs.getString(KEY_CHARACTER_WHITELIST_TAMIL, getDefaultWhitelist(languageCode));
        }
        else if (languageCode.equals("tel"))
        {
            return prefs.getString(KEY_CHARACTER_WHITELIST_TELUGU, getDefaultWhitelist(languageCode));
        }
        else if (languageCode.equals("tha"))
        {
